                ...
                <ul class="timeline">
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p>Please improve the internet connection at the 3rd floor reading room</p></div>
                            <div>&nbsp;</div>
                            <div>
                                <button class="btn btn-default btn-xs"><i class="fa fa-thumbs-o-up"></i> Like</button>
                                <span class="pull-right text-muted">127 likes - 3 comments</span>
                    ...
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body">
                                <p>Please don't switch off the AC in the labs after 5.30 in weekends. It's too hot inside.</p>
                            </div>
                            <div>&nbsp;</div>
                            <div>
                                <button class="btn btn-default btn-xs"><i class="fa fa-thumbs-o-up"></i> Like</button>
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body">
                                <p>Thank you for the relevant officials,about taking steps to provide coach for each and every sport in the university</p>
                            </div>
                            <div>&nbsp;</div>
                            <div>
                                <button class="btn btn-default btn-xs"><i class="fa fa-thumbs-o-up"></i> Like</button>
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body">
                                <p>When meeting the acdemic officials there should be a system where we can get an appointment previously and meet. Otherwise there's a lot of time wastage.</p>
                            </div>
                            <div>&nbsp;</div>
                            <div>
                                <button class="btn btn-default btn-xs"><i class="fa fa-thumbs-o-up"></i> Like</button>
